...
export const paymentMethods: PaymentConfig[] = [
  { method: 'telebirr', name: 'Telebirr', nameAmharic: 'ቴሌብር', logo: '/telebirr-logo.png', instructions: 'Pay using Telebirr mobile money. Enter your phone number to receive a payment request.', isAvailable: true, processingFee: 0 },
  { method: 'ebirr', name: 'Ebirr', nameAmharic: 'እብር', logo: '/ebirr-logo.png', instructions: 'Pay using Ebirr mobile money service. Use merchant code: LOTUS789', isAvailable: true, processingFee: 0 },
  { method: 'cbe-birr', name: 'CBE Birr', nameAmharic: 'ሲቢኢ ብር', logo: '/cbe-logo.png', instructions: 'Pay using CBE Birr mobile banking. Use merchant code: LOTUS123', isAvailable: true, processingFee: 0 },
  { method: 'amole', name: 'Amole', nameAmharic: 'አሞሌ', logo: '/amole-logo.png', instructions: 'Pay using Dashen Bank Amole. Use merchant ID: LOTUS_HOTEL', isAvailable: true, processingFee: 0 },
  { method: 'ethswitch', name: 'EthSwitch (Card)', nameAmharic: 'ኢትስዊች', logo: '/ethswitch-logo.png', instructions: 'Pay with your Ethiopian debit card through EthSwitch network.', isAvailable: true, processingFee: 25 },
  { method: 'bank-transfer', name: 'Bank Transfer', nameAmharic: 'ባንክ ዝውውር', logo: '/bank-logo.png', instructions: 'Transfer to: Commercial Bank of Ethiopia, Account: 1000XXXXXX, Name: Lotus Hotel Jijiga. Please include your booking reference.', isAvailable: true, processingFee: 0 }
];
